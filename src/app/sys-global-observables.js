...
export var runCode = ko.observable((code, gccOptions) => {
    console.log('Cannot run code as the compiler is not ready');
    console.log('Run code called with arguments:', code, gccOptions);
